...
#[derive(Debug)]
pub struct NanoFusionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoFusionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoFusion processing");
    
    let mut processor = NanoFusionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoFusionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoFusionProcessor::new(false);
